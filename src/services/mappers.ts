...
export const mandatFromRow = (r: MandatRow): Mandat => ({
  ...
  numeroRegistre: r.numero_registre ?? undefined,
  dateEnregistrement: r.date_enregistrement ?? undefined,
  regularisation: r.regularisation ?? undefined,
});
...
export const rdvFromRow = (r: RdvRow): Rdv => ({
  ...
  participantNom: r.participant_nom ?? undefined,
  date: r.date,
...
export const rdvToRow = (rdv: Rdv, agentId?: string): Partial<RdvRow> => ({
  ...
  participant_nom: rdv.participantNom ?? null,
  date: rdv.date,
