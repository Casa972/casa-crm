    ...
    <div className="mx-auto max-w-[900px] px-6 py-5">
      ...
      <div className="mb-6 grid gap-3 sm:grid-cols-2">
        <button onClick={() => setOpen("mandat_loc")} className="card p-4 text-left hover:border-primary/40">
          ...
          <p className="mt-1 text-[12px] text-ink-muted">Recherche de locataire, exclusif ou simple — honoraires et mission</p>
        </button>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <button className="card p-4 text-left hover:border-primary/40" onClick={() => void downloadFicheApportAffaires()}>
        ...
        <button className="card p-4 text-left hover:border-primary/40" onClick={() => void downloadFicheApportPromo()}>
